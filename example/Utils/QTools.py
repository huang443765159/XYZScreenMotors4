...
from PyQt5.QtWidgets import QStyledItemDelegate, QAbstractItemView, QHeaderView, QTableWidgetItem, QTableWidget
...
def set_led_flash_once(ui_btn, color_on: str, color_off: str, delay=0.5):
    set_led_style(ui_btn=ui_btn, color=color_on)
    QTimer.singleShot(int(delay * 1000), lambda: set_led_style(ui_btn=ui_btn, color=color_off))
